...
Keep in mind that if you [haven't selected a license](https://choosealicense.com/no-license/), others cannot build upon your ideas. Consider using permissive licenses to encourage development.
...
- ✅ Completed (move to an [Awesome](https://github.com/sindresorhus/awesome) list instead)
