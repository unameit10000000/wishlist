<!-- Congrats on proposing a new wishlist item! 🎉 -->
...
- [ ] **You have to review at least 2 other [open proposals](../../pulls?q=is%3Apr+is%3Aopen).**
...
## Requirements for your Wishlist proposal

- [ ] **Includes a clear problem statement and solution overview at the top of the proposal.**
- [ ] The repo name should be in lowercase slug format: `wishlist-name-of-feature`.
...
- [ ] Has an appropriate license (preferably [CC0](https://creativecommons.org/publicdomain/zero/1.0/)).
...
- [ ] To verify that you've read all the guidelines, please comment on your pull request with just the word `innovation`.

## Proposal Status Labels

Your proposal should include one of these status labels:
- 🌱 `concept` - Initial idea stage
- 💭 `discussion` - Under active discussion/refinement
- 🛠️ `development` - Someone is working on it
- ✨ `partial` - Partially implemented
- ✅ `completed` - Successfully implemented (move to awesome list)
